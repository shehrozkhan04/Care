...
?>  
    ...
    <body>
        ...
        <div class="container">
            <h1 class="text-center mt-5">Doctors in Karachi</h1>
            <div class="line">
                <div class="line1"></div>
            </div>
                ...
                ?>
                        <a href="confirmApp.php?doctor=<?php echo urlencode($doctor_name); ?>&specialty=<?php echo urlencode($doctor_specialization); ?>" class="d-card1">
                            ...
                            <div class="c-text">
                                ...
                                <p>City: <?php echo htmlspecialchars($row['city']); ?></p> <!-- City ko show karne ke liye -->
                            </div>
                        </a>
                <?php
                    }
                } else {
                    echo "<p class='text-center'>No doctors available in Karachi at the moment.</p>";
                }
                ?>
            </div>
        </div>
