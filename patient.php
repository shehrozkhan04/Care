...
// Retrieve patient data using the session
$patient_email = $_SESSION['customer'];
$querypatient = "SELECT * FROM patient WHERE email = '$patient_email'";
...
if ($resultpatient && mysqli_num_rows($resultpatient) > 0) {
    ...
    // Display patient's specific data (e.g., name, specialties, etc.)
} else {
...
<body>
    ...
    <div class="main-content">
        <h1 class="header">Welcome, <?php echo htmlspecialchars($patient['name']); ?>!</h1>
